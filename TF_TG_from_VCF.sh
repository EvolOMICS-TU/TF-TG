...
#Please enter a RUN_ID below. It can be any identifier.
run=
...
pwms=/path/to/directory/containing/pwm/motifs
list=/path/to/list/of/SRGs.txt
tf=/path/to/TF_Information(CISBP).txt
ref_gen=/path/to/reference/genome.fa
matrix=/path/to/R/script/networks_1.R
matrix2=/path/to/R/script/networks_2.R

#+ve stranded upstream genes coordinates
#The coordinates should be of the form 3:1313091-1313296 or Chr3:1313091-1313296
ups_coords_1=/path/to/list/of/ups/coordinates/for/positive/strand/genes.txt

#-ve stranded upstream genes coordinates
#The coordinates should be of the form 3:1313091-1313296 or Chr3:1313091-1313296
ups_coords_2=/path/to/list/of/ups/coordinates/for/negative/strand/genes.txt
...
details=/path/to/details/file/generated/in/STEP_9/
